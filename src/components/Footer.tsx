    ...
    <footer className="bg-dark text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-bold mb-3 text-sand text-sm uppercase tracking-wider">Quick Links</h4>
            <ul className="space-y-2 text-sm text-white/70">
              ...
              <li><Link href="/about-us" className="hover:text-sand transition-colors">About Us</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-white/70">
              <li>
                ...
                <p className="text-xs text-white/40">NZ travel planning</p>
              </li>
              <li className="pt-2">
        ...
        <div className="border-t border-white/10 mt-8 pt-8 text-center text-sm text-white/40">
          &copy; 2026 Guest Australia. All rights reserved.
        </div>
      </div>
    </footer>
  );
